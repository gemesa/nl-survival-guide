...
- Arrange housing. After arrival, just use the company HQ as address temporarily (up to 4 months max.).
  - Platforms:
    - T1:
      ...
      - https://www.vastgoednederland.nl/
  ...
  - Docs:
    ...
    - UWV statement of employment history (Verzekeringsbericht) **without BSN** (provided by [UWV](https://mijn.uwv.nl), can be requested **online with DigiD**).
      ...
      - It takes ~2 months to fill with data.
...
- Tax and investment accounts.
  ...
  - Open accounts: [XTB](https://www.xtb.com/int) | [Trading 212](https://www.trading212.com/) | [Saxo](https://www.saxoinvestor.com/login/) | [IBKR](https://www.interactivebrokers.ie/en/home.php) | [DEGIRO](https://www.degiro.nl/) | [Trade Republic](https://traderepublic.com/en-de).
